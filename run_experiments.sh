...
python3 main.py --dataset cifar10 --epochs 10

echo "在 CIFAR-10 上运行 原版VFL 算法..."
python3 vanilla_vfl.py --dataset cifar10 --epochs 10
...
python3 main.py --dataset cinic10 --epochs 10

echo "在 CINIC-10 上运行 原版VFL 算法..."
python3 vanilla_vfl.py --dataset cinic10 --epochs 10
