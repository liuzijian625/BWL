...
# --- Generic Bottom Models ---

class FCNN_Bottom(nn.Module):
    """A 3-layer FCNN for a bottom model."""
    def __init__(self, input_dim, output_dim):
        super(FCNN_Bottom, self).__init__()
...
def ResNet18_Bottom(output_dim):
    return ResNet(BasicBlock, [2, 2, 2, 2], output_dim)

# --- BWL-Specific Bottom Models ---

class FCNN_Shadow(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(FCNN_Shadow, self).__init__()
...
class FCNN_Private(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(FCNN_Private, self).__init__()
        self.fc1 = nn.Linear(input_dim, 32)
        self.fc2 = nn.Linear(32, 16)
        self.fc3 = nn.Linear(16, output_dim)
        self.relu = nn.ReLU()
...
ResNet18_Shadow = ResNet18_Bottom
ResNet18_Private = ResNet18_Bottom

# --- Top Models ---

class FCNN_Top_3(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(FCNN_Top_3, self).__init__()
...
class FCNN_Top_4(nn.Module):
    def __init__(self, input_dim, output_dim):
        super(FCNN_Top_4, self).__init__()
